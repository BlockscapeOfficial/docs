...
Below tutorial will help you understand how to add Blockscape network RPC on imToken through chainlist.org and transfer/receive tokens on fuse network in imToken wallet.   
...
**Step 4:** Once the Chainlist Dapp is open click on “Connect wallet” at right hand top corner and once the wallet is connected search of “Blockscape” on the list of EVM networks. Click on “Add to imToken” next to Blockscape Mainnet and “Approve” the details of Blockscape RPC on the next step as shown below.
...
**Step 5:** Now you have successfuly added Blockscape network RPC on imToken wallet. You can now send/receive Blockscape network assets on imToken wallet.  

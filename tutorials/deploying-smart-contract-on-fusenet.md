...
Blockscape is an EVM compatible network, every tool for Ethereum can be used for the Blockscape network too.
...
Since we interact with remix using Metamask, you need to change the network to Blockscape network by adding a custom RPC. Please follow the steps in [this tutorial](https://docs.blockscape.net/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask) to do that.

You need to have a small balance of BLC on the Fusenet wallet you are using which will be used as Gas for the transactions.

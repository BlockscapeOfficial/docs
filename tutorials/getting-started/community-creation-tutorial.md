...
description: >-
  ...
  the Blockscape Studio. The guide is aimed at teaching you how to create a new
  community after setting up Metamask or Torus and is
---

# Community creation tutorial

Make sure you are connected to the Blockscape network on your Metamask wallet before creating the community. Learn how to add Blockscape network to Metamask using [this](https://docs.blockscape.net/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask) tutorial.

Navigate to https://studio.blockscape.net/ and click on **“Login”** at the right hand top corner as shown below. Use your Gmail account to Sign in.
...
You can also view both your ETH balance and BLC balance by clicking on “Blockscape network”
...
Select whether you want to **“Create a new token”** or **“Use an existing token on Blockscape”**
...
Clicking on **“Issue”** will ask for a sign from your wallet. Please confirm the transaction from your wallet which is signed in to Blockscape network.

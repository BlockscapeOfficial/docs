...
**Please use this tutorial at your own risk as it involves using Etherscan UI/Blockscape explorer to relay the tokens. This tutorial is applicable only for BLC20 tokens other than BLC. Do not use this tutorial to transfer BLC.** 
...
Once the transaction is confirmed on-chain we wait for 2 blocks to ensure security of transaction and then the USDT tokens should appear on your Blockscape address and have been swapped from Ethereum mainnet to Fusenet.
...
https://scan.blockscape.net/address/0xFaDbBF8Ce7D5b7041bE672561bbA99f79c532e10/write\_proxy

![](../../.gitbook/assets/4%20%286%29.png)

Make sure that the network is BLC network. If you have not added Blockscape network please follow the instructions [here](https://docs.blockscape.net/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask).
...
[https://scan.blockscape.net/address/0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03/write\_proxy](https://scan.blockscape.net/address/0xc2220646E1E76D5fF3a441eDd9E8EFF0e4A8EF03/write_proxy)
...
After the transaction is confirmed on Blockscape network, the bridge oracle will relay your tx on Ethereum. No need to wait for additional confirmations as Blockscape is PoS network. After sometime you should be able to see the successful transfer of the token on your BLC20 address.

...
This tutorial will walk you through the steps needed to connect your Ledger to Metamask and use it to transact on Blockscape after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change the network to “Blockscape network” and perform the transactions on Blockscape network through your Ledger device.

Note: To learn how to add Blockscape RPC follow [this link.](https://docs.blockscape.net/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)

...
For developers who wish to integrate the WalletConnect functionality into their dApps running on Blockscape, we recommend using [this library](https://www.npmjs.com/package/@fuseio/walletconnect-web3-provider).

...
The Blockscape Studio REST API for accessing the data and the services of the Blockscape network in a simple way. You can use this API to query and interact with the objects of the Blockscape network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Blockscape network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Blockscape\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Blockscape network |
...
| homeBridgeAddress | `String` | Bridge address on the Blockscape network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Blockscape network |
...
Community is a set of contracts and services. Members of the community are users of the Blockscape network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Blockscape network |
| homeTokenAddress | `String` | Address of the community token on the Blockscape network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Blockscape network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Blockscape network |
...
Entity is an account on the Blockscape network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Blockscape network |

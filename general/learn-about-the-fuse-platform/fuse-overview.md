# Blockscape Overview: vision, strategy and platform components

Blockscape is a decentralized blockchain-powered platform and technology stack whose goal is to enable genuine mass adoption of crypto payments and decentralized finance (DeFi).&#x20;
...
The Blockscape platform has three main components:&#x20;

1\) **The Blockscape blockchain**. The EVM-compatible public blockchain is the decentralized, permissionless backbone of the Blockscape platform and ecosystem.&#x20;

2\) **The mobile-centric open-source technology stack** designed to help businesses and developers plug crypto payments into real-world use cases. This toolkit has subsumed into the new [Blockscape Charge](https://chargeweb3.com/) API platform.&#x20;
